...
import 'package:docwise/pages/marathi_page/reuired_document_m.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

class DocumentDetailsPageMarathi extends StatelessWidget {
  final String mainTitle;
  final Map<String, dynamic> fields;
  final String logo;

  const DocumentDetailsPageMarathi({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, Map<String, dynamic>> sections = {
      'आवश्यक कागदपत्रे': fields['required_document'],
      'यासाठी पावले': fields['steps_to_follow'],
      'नियम आणि अटी': fields['terms&cond'],
      'इतर': fields['other']
    };
                                  ...
                                  onPressed: () {
                                    print(sectionTitle);
                                     Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              RequiredDocumentMarathi(mainTitle: mainTitle,sectionTitle: sectionTitle , fields: fields)
                                        ),
                                      );
                                  },
